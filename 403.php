...
$pageFile        = '403.php';
$pageTitle       = 'Access Denied | Purbachal Apparel Limited';
$pageDescription = '';
...
<section class="page-hero" style="min-height:60vh;display:flex;align-items:center">
  <div class="container" style="text-align:center;padding-top:4rem;padding-bottom:4rem">
    <p class="eyebrow" style="margin-bottom:1rem">403 Error</p>
    <h1 style="font-size:clamp(2rem,5vw,3.25rem);margin-bottom:1.25rem">Access Denied</h1>
    <p style="font-size:1.125rem;color:var(--text-muted);max-width:520px;margin:0 auto 2.5rem">
      You do not have permission to access this page. If you believe this is a mistake, please contact us.
    </p>
