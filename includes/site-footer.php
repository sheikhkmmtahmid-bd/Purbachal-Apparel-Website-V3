    ...
    <div class="footer-grid">
      <div class="footer-brand">
        ...
        <div class="footer-social">
          ...
          <a href="<?php echo e($social[$key]); ?>" class="footer-social-link" aria-label="<?php echo e($label); ?>" target="_blank" rel="noopener"><?php echo getSocialIconSvg($key, 16); ?></a>
          <?php endforeach; ?>
        </div>
      </div>
...
<div class="fab-group">
  ...
  <a href="admin/dashboard.php" target="_blank" rel="noopener" class="fab fab-admin" aria-label="Admin">
